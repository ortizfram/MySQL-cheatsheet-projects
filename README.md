...
# SQL_cheatsheet_projects_exercises
...
![image](https://user-images.githubusercontent.com/51888893/184663955-bac216ff-6ef7-484a-b22a-78b70be7093e.png)

![image](https://user-images.githubusercontent.com/51888893/184663981-234e5741-31c4-4270-b9db-c2969ad752fb.png)
...
💁show fiends names w self join in paired friends 

	SELECT a.fullname, b.fullname AS pairfriend
	FROM friends
	JOIN persons a
...
![image](https://user-images.githubusercontent.com/51888893/184677782-a119164b-b915-4e3e-875c-e085dbb29589.png)

-----------------------------------------------
# *️⃣ update a database:
	CREATE TABLE users (
	    id INTEGER PRIMARY KEY,
	    name TEXT);
